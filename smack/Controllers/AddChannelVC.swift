...
class AddChannelVC: UITableViewController {
    ...
    @IBAction func addChannel(_ sender: Any) {
        ...
        MessageService.instance.addChannel(name: channelName, description: channelDescription) { (success) in
            print("Add Channel Status: \(success)")
